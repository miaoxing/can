    ...
    <form id="permission-form" class="form-horizontal" method="post" permission="form">
      ...
      <div class="clearfix form-actions form-group">
        <div class="offset-lg-2">
          ...
          &nbsp; &nbsp; &nbsp;
          <a class="btn btn-secondary" href="<?= $url('admin/permissions') ?>">
...
<?= $block->js() ?>
<script>
  require(['plugins/admin/js/form', 'ueditor', 'plugins/admin/js/data-table', 'plugins/app/js/validation'], function () {
    $('#permission-form')
